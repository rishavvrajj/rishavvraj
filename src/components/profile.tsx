      ...
      <div className=" text-blue-50">
        <div className="-mt-21 flex gap-3 items-center">
          ...
          <div className="flex flex-col gap-0.5 sm:gap-1 md:gap-2">
            ...
            <span className="text-xs sm:text-sm md:text-md opacity-50 tracking-tighter">Full-Stack and AI Developer</span>
            <span className="text-[10px] sm:text-xs md:text-sm opacity-55 flex items-center gap-1"><img className="w-3.5 h-3.5 sm:w-4.5 sm:h-4.5 md:w-6 md:h-6" src="/view.png" alt="" /><b>91 </b>profile View</span>
          </div>
        </div>
      </div>
    </div>
